...
(
    ID                  int not null
        primary key,
    DecorationName      nvarchar(255),
    Decription          nvarchar(255),
    DecorationTypeID    int
        references DecorationType,
...
create table PondDecoration
(
    DecorationID int            not null
        references Decoration,
    PondID       int            not null
        references Pond,
    AreaAmount   decimal(10, 2) not null,
    primary key (DecorationID, PondID)
)
go
